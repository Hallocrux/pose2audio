# Pose2Audio.KinectBridge.KinectSdk
...
```powershell
dotnet run --project bridge\Pose2Audio.KinectBridge.KinectSdk -- --cli-output live
```

Print HRTF az/el against a chosen world source:

```powershell
dotnet run --project bridge\Pose2Audio.KinectBridge.KinectSdk -- --source-x 0 --source-y 0 --source-z 1
```
