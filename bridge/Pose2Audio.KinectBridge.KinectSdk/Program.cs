...
namespace Pose2Audio.KinectBridge.KinectSdk
{
...
@"Usage:
  Pose2Audio.KinectBridge.KinectSdk [--host 127.0.0.1] [--port 24567] [--hz 60] [--duration-sec 0] [--source-x 0] [--source-y 0] [--source-z 1] [--cli-output live|scroll]
